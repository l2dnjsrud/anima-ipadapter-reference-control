...
#   --init-checkpoint-path checkpoints/anima_qwenvl_ip_adapter_identity128_0064_20260611.safetensors \
#   --steps 64 --resolution 256 --device cuda:0 \
#   --output-path checkpoints/anima_qwenvl_ip_adapter_identity128_contrastive_0064_20260611.safetensors
...
from training.qwenvl_contrastive_smoke import run_qwenvl_contrastive_smoke  # noqa: E402
...
DEFAULT_OUTPUT: Final[Path] = ROOT / "checkpoints/anima_qwenvl_ip_adapter_contrastive_20260611.safetensors"
...
def train(
    ...
    summary = run_qwenvl_contrastive_smoke(
        config,
