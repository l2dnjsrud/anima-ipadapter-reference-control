...
from training.qwenvl_teacher_alignment_loss import qwenvl_teacher_alignment_loss
...
class QwenVLTeacherAlignmentStepWeights:
    contrastive: float
    retrieval: float
    teacher: float
...
@dataclass(frozen=True, slots=True)
class QwenVLTeacherAlignmentStepLosses:
    total: torch.Tensor
    base: torch.Tensor
...
def compute_qwenvl_teacher_alignment_total(
    *,
    base: torch.Tensor,
    contrastive: torch.Tensor,
    retrieval: torch.Tensor,
    ...
    return QwenVLTeacherAlignmentStepLosses(
        total=total,
        base=base,
...
def run_qwenvl_teacher_alignment_step(
    *,
    ...
    return compute_qwenvl_teacher_alignment_total(
        base=base,
        contrastive=contrastive,
        retrieval=retrieval,
        teacher=teacher,
