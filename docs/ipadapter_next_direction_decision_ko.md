...
SELECTED: `train_stronger_encoder`
...
| `train_stronger_encoder` | chosen | broad style/palette/costume 신호는 있으나, frozen SigLIP2 adapter-only로 identity/props/non-human trait가 부족하다. 더 강한 encoder 또는 image-encoder adaptation이 필요하다. |
